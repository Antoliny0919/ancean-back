...
def test_non_id_patch_post(base_client):
  '''
...
def test_is_finish_patch_post(base_client, is_finish, expected_response):
  '''
...
def test_category_patch_post(category, base_client, is_finish, expected_post_count):
  '''
  ...
  base_client.patch(base_client.endpoint, json.dumps(body), content_type='application/Json')
